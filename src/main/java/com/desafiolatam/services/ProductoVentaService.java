...
public class ProductoVentaService {
	...
	public List<ProductosVentas> findAllByVentaId(Long id) {
		...
		return productoVentaRepository.findAllProductosVentasWhereVenta(id);
	}

	public List<ProductosVentas> findAllProductosVentas(Long ventaId){

		return productoVentaRepository.findAllProductosVentas(ventaId);
	}
