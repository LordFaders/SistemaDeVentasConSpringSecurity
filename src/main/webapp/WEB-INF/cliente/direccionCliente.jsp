...
<jsp:include page='../template/head.jsp'>
	<jsp:param name='title' value='Agregar Dirección Cliente' />
</jsp:include>
			...
			<div class="row justify-content-sm-center h-100">
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card img-fluid">
							...
							src="/img/metal.jpg" height="830">
					<div class="card-img-overlay">
                                        <div class="card-body p-3">
							<h2 class="fs-4 card-title fw-bold text-white mb-4">Agregar Dirección Cliente</h2>
							...
							<form:form method="POST" action="/direccionCliente/agregar/cliente"
								modelAttribute="direccionCliente">
								<div class="mb-3">
									<form:select path="cliente" class="form-select">
										...
										<c:if test="${client.direccionCliente.id == null}">
